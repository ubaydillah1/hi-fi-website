    ...
    >
      <div className="container mx-auto px-4 md:px-6 max-w-[1200px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="flex flex-col space-y-7 max-w-[550px]">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-[#066EFF] text-sm font-medium w-fit border border-blue-100">
              <span className="w-2 h-2 rounded-full bg-[#066EFF]" />
              #1 Career Readiness Platform for IT Graduates
            </div>

            <h1 className="text-[40px] md:text-[52px] font-extrabold tracking-tight leading-[1.1]">
            ...
            <div className="flex flex-wrap gap-4">
              <Button
                size="lg"
                className="bg-[#066EFF] hover:bg-[#0556cc] h-14 px-8 text-[16px] rounded-[14px] shadow-lg shadow-blue-200"
              >
          ...
          <div className="relative lg:ml-auto group">
            ...
            <div className="relative overflow-hidden rounded-[2rem] shadow-2xl">
              ...
              <div className="absolute top-8 right-8 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/20 animate-in fade-in slide-in-from-right duration-700">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center">
                    <ArrowRight className="h-5 w-5 text-emerald-600 -rotate-45" />
                  </div>
                  <div>
                    <p className="uppercase tracking-wider text-gray-400 text-[11px]">
                      Skills Improved
                    </p>
