...
export default function Step6({
  ...
  const handleConnectGitHub = () => {
    ...
    const defaultGithubUsername = user?.first_name
      ? `${user.first_name.toLowerCase()}${Math.floor(10 + Math.random() * 90)}`
      : "developer";
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="actions">
              <button class="btn-authorize" onclick="authorize()">Authorize ${defaultGithubUsername}</button>
          ...
          <script>
            function authorize() {
              window.opener.postMessage({
                ...
                githubId: '${Math.floor(10000000 + Math.random() * 90000000)}',
